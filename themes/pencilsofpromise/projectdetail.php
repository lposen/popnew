...
<?php get_header(); ?>
<script src="<?php bloginfo('stylesheet_directory'); ?>/js/galleria/galleria-1.2.9.min.js"></script>
<!-- load flickr plugin -->
...
Galleria.loadTheme('<?php bloginfo('stylesheet_directory'); ?>/js/galleria/themes/classic/galleria.classic.min.js');
// Initialize Galleria
