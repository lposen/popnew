...
<div id="header">
	<div id="title">
		...
		<div id="friends">
					...
					<div class="counter">
				<a href="https://www.pencilsofpromise.org/join-the-movement/donate">100% of online donations directly fund schools.</a>
				<?php /*<img src="<?php bloginfo('template_directory'); ?>/gfx/onlineDonation.png" class="count" alt="Join the 200,000+ friends of PoP in Providing Access to Education" />*/ ?>
			</div>
