...
<meta property="og:title" content="Pencils of Promise 2012 Yearbook" />
<meta property="og:description" content="School's out. We have our 2012 #PoPYearbook. See it here! http://www.pencilsofpromise.org/yearbook" />
<meta property="og:image" content="<?php bloginfo('template_directory'); ?>/gfx/yearbook/nuth.jpg" />

<title>Pencils of Promise Yearbook</title>
<link rel="profile" href="http://gmpg.org/xfn/11" />
<!--Stylesheets-->
<!--[if lt IE 9]>
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/yearbook-ie.css">
<![endif]-->
...
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/css/yearbook.css" />

<!--[if lt IE 9]>
<script src="//html5shiv.googlecode.com/svn/trunk/html5.js"></script>
<![endif]-->
<!--Stylesheets: Target iPhone-->
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/handheld.css" media="(max-width:320px)" />
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/css/yearbook-handheld.css" media="(min-width:321px) and (max-width:480px)" />

<!--Stylesheets: Target iPad-->
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/tablet.css" media="(min-device-width:768px) and (max-device-width:1024px)" />

<!--Stylesheets: Target Galaxy Tab-->
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/tablet.css" media="(min-width:1280px) and (max-width:1280px)" />
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/tablet.css" media="(min-width:800px) and (max-width:800px)" />
...
<script>
  ...
  ga('create', 'UA-10494909-7', 'pencilsofpromise.org');
  ga('send', 'pageview');
...
<div id="loader">
    <img class="loadscreen" src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/loadscreen.jpg">
    <img class="loading" src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/loading.gif">
</div>
<div id="yearbook">
<div id="browserwarning">
    <span class="close"></span>
    <h2 class="ie">Uh Oh!</h2>
    <p class="ie">This website is not optimized for IE<span class="ieversion"></span></p>
    <p class="ie">Please <a href="http://windows.microsoft.com/en-us/internet-explorer/ie-10-worldwide-languages">upgrade to version 9 or 10</a>, view this in another browswer, or download the pdf.</p>
    <div class="download ie"><a href="http://www.pencilsofpromise.org/wp-content/uploads/2013/06/Yearbook2012.pdf"><img src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/download.png"></a></div>
    <h2 class="mobile">Just a note...</h2>
    <p class="mobile">Make sure to check this out on a computer so that you can view our cool timeline!</p> 
</div>
<div id="greyoverlay">
    <span class="close">x</span>
</div>
<div id="yearbooktoggle" class="mobileonly closed">Button</div>
<div id="yearbook-nav" class="tablet handheld">
  ...
  <div id="yearbook-nav-inner"> 
        <ul>
          <li ><a class="timeline active" href="#timeline">Timeline</a></li>
          <li> <a class="aboutus" href="#aboutus">Who We Are</a> </li>
          <li> <a class="ourimpact" href="#ourimpact">Our Impact </a></li>
          <li> <a class="outandabout" href="#outandabout"> Our Community </a></li>
          <li> <a class="financials" href="#financials"> Financials </a></li>
          <div class="bar"></div>
        </ul>
        <div id="readmore">
            <img class="arrow arrow1" src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/readmore_arrow2.png">
            <img class="text" src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/readmore_yearbook.png">
        </div>
  </div>
</div>
<div id="timeline" class="tablet handheld sections">
  <div id="timelineNuth" class="nuth"></div>
  <div id="reverseNuth" class="nuth"></div>
    <div id="share">
        <p>Share:</p>
        <div class="fb-like" data-href="http://www.pencilsofpromise.org/yearbook" data-send="false" data-layout="standard" data-width="450" data-show-faces="true"></div>
        <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.pencilsofpromise.org/yearbook" data-text="PoP's 2012 year is now an interactive #PoPYearbook. School's out & it just launched! See it here:" data-count="true" data-lang="en" data-counturl="http://www.pencilsofpromise.org/yearbook">Tweet</a>
  ...
  <div id="timeline-inner">
    ...
    <div id="welcome">
        <div id="nuthhut"></div>
        <h4>2012 Timeline<span>See PoP's milestones as you walk to school with Nuth</span></h4>
      <div id="welcoming">
          <div class="info_box arrow_box_left arrow_box">
                <p class="meetnuth">Hi, I'm Nuth - PoP's first student.</p>
                <p class="tour">I would like to take you on a tour through 2012 at PoP.</p>       
                <p class="adam">But first, a few words from PoP's founder!</p>
          </div>
      ...
      <div id="instructions">
            <div class="guide"><span>Use</span>
                ...
                <span>to guide Nuth.</span>
            </div>
            <div class="mousover">
                <p>Mouseover <span class="infoicon">i</span> for more information</p>
            </div>
         </div>
    </div>
    <div id="jan" class="month"> 
      ...
      <div id="janheader" class="monthheader">
          <h6 >JANUARY 2012</h6>
      ...
      <div class="info waterfall">
        ...
        <div id="infoboxwf" class="info_box arrow_box_bottom arrow_box">
    ...
    <div id="newoffice" class="monthheader">
      <h6 >FEBRUARY 2012</h6>
      ...
      <div class="info">
        ...
        <div id="infoboxtv" class="info_box arrow_box_bottom arrow_box">
            <p>Our old office, and our new one!</p>
          <img class="officebefore" src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/officebefore.jpg">
          <img class="officeafter" src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/officeafter.jpg">
        </div>
      </div>
  ...
  <div id="jun" class="month">
      <div class="info rain">
        ...
        <div id="infoboxrain" class="info_box arrow_box_left arrow_box">
    ...
    <div id="kennedy" class="monthheader">
        <h6>JUNE 2012</h6>
    ...
    <div class="info kennedy">
        ...
        <div id="infoboxkennedy" class="info_box arrow_box_left arrow_box">
          <p>Kennedy raised enough money to build two classrooms through this trip!  Check out Kennedy and other Impossible Ones <a class="outandabout" href="#outandabout">here</a>
          </p>
        </div>
      </div>
    <div id="bike"></div>
  ...
  <div id="jul" class="month">
    <div id="plane"></div>
    <div id="julyheader" class="monthheader">
        <h6>JULY 2012</h6>
      ...
      <div class="info sophia">
        ...
        <div id="infoboxsophia" class="info_box arrow_box_top arrow_box">
          <p>Sophia built 2 schools in Guatemala for 30 for 30. Check out Sophia and other Impossible Ones <a class="outandabout" href="#outandabout">here</a>
          </p>
        </div>
      </div>
    <div id="tree-f"></div>
    ...
    <div class="info temple">
        ...
        <div id="infoboxtemple" class="info_box arrow_box_left arrow_box">
  ...
  <div id="aug" class="month">
    <div id="augheader" class="monthheader">
        <h6>AUGUST 2012</h6>
    ...
    <div class="info freeman">
        ...
        <div id="infoboxfreeman" class="info_box arrow_box_right arrow_box">
  ...
  <div id="septheader" class="monthheader">
   ...
   <div id="chalkboard"></div> 
    ...
    <div id="septheader2" class="monthheader">
        <span>... and PoP breaks ground in Ghana.</span><br>
        <span class="schoolcount">86 Schools</span>
   </div>
    
    <div class="info programming">
        <div class="infoicon" id="infoiconprogramming">i</div>
        <div id="infoboxprogramming" class="info_box arrow_box_left arrow_box">
    ...
    <div id="octheader" class="monthheader">
        <h6>OCTOBER 2012</h6>
    ...
    <div id="octheader2" class="monthheader">
        <span>...and Pencils of Promise broke ground on a new school every day.</span>
    </div>
    <div id="hotair"></div>
    <div id="tree-g1"></div>
  </div>
  ...
  <div id="artifacts"></div>
    <div class="info" style="display:block;">
      ...
      <div id="infobox3" class="info_box arrow_box_bottom arrow_box">
    ...
    <div id="tree-i"></div>
    <div id="novheader" class="monthheader">
        <h6 >NOVEMBER 2012</h6>
   ...
   <div id="threed" class="arrow_box_bottom arrow_box">
      <iframe width="420" height="255" src="http://www.youtube.com/embed/_W9p0wiaaQs?autoplay=1" frameborder="0" allowfullscreen></iframe>
    </div>
    <div class="info" style="display:block;">
  ...
  <div id="thankyou">
  <div id="endheader" class="monthheader">
      <h6>JANUARY 2013</h6>
    ...
    <div id="educate">
        ...
        <p>Help educate a child like Nuth<a href="https://www.pencilsofpromise.org/join-the-movement/donate?utm_source=2012yearbook&utm_medium=website&utm_content=donate&utm_campaign=cta" class="donate">Make a Gift</a></p> 
        <div id="endshare">
            <p style="font-weight:bold; margin-bottom:10px;"><span>$10</span> is donated every time this page is shared!</p><br><br>
            <p>Share now:</p>
            <div class="fb-like" data-href="http://www.pencilsofpromise.org/yearbook" data-send="false" data-layout="standard" data-width="450" data-show-faces="true"></div>
        <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.pencilsofpromise.org/yearbook" data-text="PoP's 2012 year is now an interactive #PoPYearbook. School's out & it just launched! See it here:" data-count="true" data-lang="en" data-counturl="http://www.pencilsofpromise.org/yearbook">Tweet</a>
            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
...
<div id="aboutus" class="sections">
  <div class="sidebar pageshadow mobilenone">
    <ul>
    ...
    <div class="donateshare">
        <a href="https://www.pencilsofpromise.org/join-the-movement/donate?utm_source=2012yearbook&utm_medium=website&utm_content=donate&utm_campaign=cta" class="donate">Donate</a>
        <div class="share">
              <!--<img src="http://dbc468c6af3659a35fbc-f0981fd138ea8adbe310045bdc6ef280.r92.cf1.rackcdn.com/NAVIGATION-LOGO-2.png" >-->
              <div class="download"><a href="http://www.pencilsofpromise.org/wp-content/uploads/2013/06/Yearbook2012.pdf"><img src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/download.png"></a></div>
                      <div class="fb-like" data-href="http://www.pencilsofpromise.org/yearbook" data-send="false" data-layout="standard" data-width="450" data-show-faces="true"></div>
        <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.pencilsofpromise.org/yearbook" data-text="PoP's 2012 year is now an interactive #PoPYearbook. School's out & it just launched! See it here:" data-count="true" data-lang="en" data-counturl="http://www.pencilsofpromise.org/yearbook">Tweet</a>
  ...
  <div class="content">
					...
					<div id="bb-bookblock" class="bb-bookblock">
						...
						<div class="bb-item hundred">
                               <div class="bb-custom-page">
                                ...
                                140 pre and primary schools in remote and underserved regions of these countries. Each school 
    ...
    <div id="partnerships" class="container pageshadow">
        ...
        <div id="bandn" class="partners"> 
            ...
            <img class="studentswithnooks" src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/studentswithnooks.png">
         ...
         <div class="movetimeline">
             <div class="ten block">
                 ...
                 <div class="text">
                     ...
                     <h4>July 2010</h4>
                     <p>We opened our 1st PoP office in NYC!</p>
        ...
        <h2>School Culture</h2>
          ...
          <div class="ca-wrapper">
              ...
              <div class="ca-item ca-item-4">
                  <img src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/teddy.png">                  
...
<div id="ourimpact" class="sections">
  <div class="sidebar pageshadow mobilenone">
    <ul>
      ...
      <li>
          <a href="#impactmetrics" class="scroll">
            <h7 class="impactmetrics">M&E Staff</h7><span></span>
          </a> 
      </li>
    </ul>
    <div class="donateshare">
...
<p>Pencils of Promise was founded with the goal of building long-term, sustainable change in partnership with communities. We know the best way to accomplish this is through strong local leadership.</p>
...
solution.</p>
    ...
    <div id="ourapproach" class="container pageshadow"> 
     ...
     <div class="inner">
      ...
      <h4>However, a school is much more than a building.</h4>
              ...
              <p>Scroll down to see the programs that PoP established in 2012 to accomplish this mission. </p>
              </div>
        <div class="clearfix"></div>
    ...
    of socio-economic situation, gender or ethnicity.</p>
...
to help PoP reach its impossible goal of breaking ground on the 100th school by the end of the year.</p>
        <p class="yellowcorner">Meet some of the people who prove we all have the potential to be an Impossible One</p>

						<div class="io">
                            <div id="OAsophia"></div>
                            <p><span class="dark">Sophia</span> donated her 30th birthday and built 2 schools in Guatemala</p>
						...
						<div class="io">
                            ...
                            <p><span class="dark">Kennedy</span> biked across the country and built 2 classrooms</p>
                            <img class="bike" src="http://dbc468c6af3659a35fbc-f0981fd138ea8adbe310045bdc6ef280.r92.cf1.rackcdn.com/bike%20icon.jpg">
                            
                        </div>
						<div class="io">
                                <div id="OAjustin"></div>
                                <p><span class="dark">Justin</span> built a school by harnessing the power of dance music and matching all proceeds from his track “Back to New”</p>
    ...
    world. Money raised during the campaign went to PoP’s programs in Ghana, Guatemala, Laos and Nicaragua. 
               ...
               <p class="second">Justin Bieber returned as the ambassador for the campaign and with his support over 13,000 schools signed up to join the 
    Schools4All movement!
               ...
               <div id="meetwinners">
                   ...
                   <iframe class="s4amodal" width="640" height="480" src="http://www.youtube.com/embed/KtKFJDffAyY?&start=123" frameborder="0" allowfullscreen></iframe>
...
3 schools!</p>
        <div>
          <div class="highlightsfield left dropshadow"> 
          ...
          <div class="highlightsfield right dropshadow"> 
        ...
        <div id="pressquote">
				<p class="quote">For us at PoP , we know that we can create 
				a better world through education as has been 
				the vision of our founder.”</p>
                <p class="freeman title">FREEMAN<br/>
       <span>National Daily Graphic newspaper</span><br/>
       <span>December 2012</span></p>
       <div class="clearfix"></div>
		</div>
    ...
    <div id="digipresence" class="container pageshadow"> 
      ...
      <nav>
          ...
          <ul class="center">
              ...
              <li class="mentions">Average Daily Twitter<br> Mentions</li>
          </ul>
          <ul class="">    
        ...
        <div class="digstats">
            <img class="mac" src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/mac.png">
            <div class="screen">
                  <div id="webvisits" class="DPstats web"> 
                      <div class="webbackground"></div>
                      <div class="webstats">
                          <img src="<?php bloginfo('template_directory'); ?>/gfx/yearbook/digital_webviews.png" > 
                      </div>
                  </div>
                  <div id="pageviews" class="DPstats web"> 
                      <div class="webbackground"></div>
                      <div class="webstats">
                ...
                <div id="tweeter" class="DPstats twitter"> 
                    <div class="webbackground"></div>
                    <div class="webstats">
                ...
                <div id="community" class="DPstats web"> 
                    <div class="webbackground"></div>
                    <div class="webstats">
              ...
              <div id="mentions" class="DPstats twitter">
                  <div class="webbackground"></div>
                  <div class="webstats">
...
and invest heavily in our new teacher training and student scholarships programs.</p>
    ...
    <div class="FFsect">
      ...
      <div id="holder">
        <div class="charttext charttext1"> TOTAL 
          SUPPORT
...
IN 2011</p>
						...
						--> 
                        <div id="holder2">
        <div class="charttext2 charttext"> TOTAL EXPENSES <span>$3,208,562 </span> </div>
        <div class="clearfix"></div>
      </div>
    </div></div>
    <div class="clearfix"></div>
