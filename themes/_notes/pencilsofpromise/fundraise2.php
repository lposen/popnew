...
<div id="main">
    <div id="fundraiseLinks" style="width: 60%;
height: 50px;
margin: 0 auto;">
        <a href="http://fundraise.pencilsofpromise.org/login" class="gold_button">Login</a>        
        <a href="http://fundraise.pencilsofpromise.org/fundraise/create?eid=15845" class="gold_button">Create Your Own Fundraiser</a>
    </div>
...
<div class="fundraise-sub-menu">
	...
	<a href="http://fundraise.pencilsofpromise.org/fundraise/create?eid=15845&goal=25000"    onmouseover="$('.vector-1').hide();$('.vector-1-dot').hide();$('.vector-2').hide();$('.vector-2-dot').hide();$('.vector-3').hide();$('.vector-3-dot').hide();$('.vector-4').hide();$('.vector-4-dot').hide();$('.vector-5').show();$('.vector-5-dot').show();" style="color: black; font-weight: bold;padding-right: 0px;">Build a School</a>
</div>
