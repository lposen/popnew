...
<html style="margin-top: 0px !important"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body class="home iphone" style="background: none !important">
		<div id="page-wrap">
		...
		<div id="navigation">
			...
			<div id="titlecard"><!-- titlecard -->
					...
					<div id="takeactioncard"><!-- takeactioncard-->
								...
								<![endif]-->
								  ...
								  <form action=" " method="post"> 
									...
									<div class="progress-cont">
												<img src="http://staging.pencilsofpromise.org/wp-content/themes/pencilsofpromise/gfx/whoweareImage2.png" alt="">
											</div>
								  <div class="step donation-slider" style="padding: 10px;"> 
								  <div class="form-container-nobg">

								  	<div id="slider-cont" style="width: 270px">
								  ...
								  <div class="step-padding" style="	background: white;
								  ...
								  <div class="step" style="padding: 10px 90px 40px 90px"> 
						...
						<div id="aboutuscard"><!-- aboutuscard-->
								<div id="aboutuscard-bg">
									<div id="aboutus-top"></div>
									<div id="aboutus-bottom"></div>
								</div>
						...
						<div id="whowearecard"><!-- whowearecard-->
								<div id="whowearecard-bg">
									<div id="whoweare-top">
										<div id="whoweare-top-caption"></div>
									</div>
									<div id="whoweare-middle">
										<div id="whoweare-middle-caption"></div>
									</div>
									<div id="whoweare-bottom">
										<div id="whoweare-bottom-caption"></div>
									</div>
								</div>

						</div><!-- whowearecard - end -->
