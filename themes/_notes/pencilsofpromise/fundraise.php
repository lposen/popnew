...
<div id="ipromise">
	...
	<div id="fundraise-introduction" style="background: url('<?php echo $thumb[0]; ?>');">    
        ...
        <iframe width="500" height="300" src="http://www.youtube.com/embed/7CQ8r-9SUvA" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>
...
<div class="fundraise-sub-menu">
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21885"    onmouseover="$('.vector-1').show();$('.vector-1-dot').show();$('.vector-2').hide();$('.vector-2-dot').hide();$('.vector-3').hide();$('.vector-3-dot').hide();$('.vector-4').hide();$('.vector-4-dot').hide();$('.vector-5').hide();$('.vector-5-dot').hide();">Educate One Child</a>
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21880"    onmouseover="$('.vector-1').hide();$('.vector-1-dot').hide();$('.vector-2').show();$('.vector-2-dot').show();$('.vector-3').hide();$('.vector-3-dot').hide();$('.vector-4').hide();$('.vector-4-dot').hide();$('.vector-5').hide();$('.vector-5-dot').hide();">Educate Ten Children</a>
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21882"    onmouseover="$('.vector-1').hide();$('.vector-1-dot').hide();$('.vector-2').hide();$('.vector-2-dot').hide();$('.vector-3').show();$('.vector-3-dot').show();$('.vector-4').hide();$('.vector-4-dot').hide();$('.vector-5').hide();$('.vector-5-dot').hide();">Sponsor a Classroom</a>
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21883"    onmouseover="$('.vector-1').hide();$('.vector-1-dot').hide();$('.vector-2').hide();$('.vector-2-dot').hide();$('.vector-3').hide();$('.vector-3-dot').hide();$('.vector-4').show();$('.vector-4-dot').show();$('.vector-5').hide();$('.vector-5-dot').hide();">Build a Classroom</a>
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21884"    onmouseover="$('.vector-1').hide();$('.vector-1-dot').hide();$('.vector-2').hide();$('.vector-2-dot').hide();$('.vector-3').hide();$('.vector-3-dot').hide();$('.vector-4').hide();$('.vector-4-dot').hide();$('.vector-5').show();$('.vector-5-dot').show();" style="color: black; font-weight: bold;padding-right: 0px;">Build a School</a>
</div>
...
<div class="vector-1-dot vector-info">	<div class="vector-info">
	...
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21885">Get Started ></a>
	</div>
</div>
</div>
...
<div class="vector-2-dot vector-info">	<div class="vector-info">
	...
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21880">Get Started ></a>
	</div>
</div>
</div>
...
<div class="vector-3-dot vector-info">	<div class="vector-info">
	...
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21882">Get Started ></a>
	</div>
</div>
</div>
...
<div class="vector-4-dot vector-info">	<div class="vector-info">
	...
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21883">Get Started ></a>
	</div>
</div>
</div>
...
<div class="vector-5-dot vector-info">
	...
	<a href="https://fundraise.pencilsofpromise.org/checkout/donation?eid=21884">Get Started ></a>
	</div>
</div>
</div>
    ...
    <div id="fundraiseLinks">
        <a href="http://fundraise.pencilsofpromise.org/login" id="fundraiseLinkLogin">Login ></a>        
        <a href="http://fundraise.pencilsofpromise.org/fundraise/create?eid=15845" id="fundraiseLinkCreate">Create Your Own Fundraiser ></a>
    </div>
    
    <div id="fundraiseBorderUpper"></div>
    
    <div id="fundraiseTitleChallenge" class="BebasNeue">2012 CHALLENGE PROGRESS</div>
