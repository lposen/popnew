...
$("#yearbook-nav-inner ul li a").click(function() {
	...
	$("#yearbook-nav-inner ul li a").removeClass("active");
    $(this).addClass("active");
    if(!isShowing && $(this).hasClass("showTimeline2")){}
    else if(!isShowing){
        timelineout();
        $('.sections').hide();
       isShowing = true;
...
$(".animation").hide();
$("#timeline").scroll(function(e) {
    /*var array = [450, 950, 1650, 2300, 2800, 3250, 3800, 4000, 4500, 5120, 5700];
    var array2 =[950, 1650, 2300, 2800, 3250, 3800, 4000, 4500, 4900, 5500, 7000];*/
    var array = [650, 1150, 1850, 2500, 3000, 3450, 3900, 4100, 4600, 5240, 5610];
...
function hotair_animate() {
    $("#hotair").animate({top: '90px'}, 1000, function() {
	});
}
